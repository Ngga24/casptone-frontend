...
export default function InputActivityPage() {
  ...
  const fields = [
    { name: "sleep_duration", label: "Sleep Duration (hours)", placeholder: "e.g. 7" },
    { name: "study_work_duration", label: "Study / Work Duration (hours)", placeholder: "e.g. 6.5" },
    { name: "exercise_duration", label: "Exercise Duration (hours)", placeholder: "e.g. 1" },
    { name: "downtime_duration", label: "Downtime Duration (hours)", placeholder: "e.g. 2" },
    { name: "task_planned", label: "Task Planned (total)", placeholder: "e.g. 10" },
    { name: "task_completed", label: "Task Completed (total)", placeholder: "e.g. 8" },
  ];
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6 md:p-8 shadow-sm">
          ...
          <div className="mb-8">
            ...
            <p className="text-xs text-slate-400 mt-1 font-light">
              Masukkan metrik aktivitas harian Anda untuk memperbarui visualisasi dashboard dan analisis AI Twin.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-2">
              ...
              >
                {loading ? "Processing AI Analysis..." : "Save & Analyze Activity"}
              </button>
            </div>

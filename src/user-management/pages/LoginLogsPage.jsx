    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 p-8 flex flex-col h-full overflow-hidden">
        <div className="max-w-6xl mx-auto w-full flex flex-col h-full">
          {/* BAGIAN HEADER & SEARCH BAR (TIDAK AKAN IKUT SCROLL) */}
                        ...
                        <tr key={log.id} className="hover:bg-slate-50/50">
                          ...
                          <td className="px-6 py-4 text-slate-600">
                            <div className="flex items-center gap-2">
                              ...
                              />
                              <span className="break-words">{log.device}</span>
                            </div>
                          </td>
                          <td className="px-6 py-4 text-center">
                            <div className="flex flex-col items-center gap-1.5">
                              <span
                                className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-semibold uppercase tracking-wider ${isSuccess ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : "bg-red-50 text-red-600 border border-red-100"}`}
                              >
                                {isSuccess ? (
                                  <ShieldCheck size={12} />
                                ) : (
